#!/bin/bash
if ! [ -L /home/vagrant/ecommerces ]; then
  rm -rf /home/vagrant/ecommerces
  ln -fs /vagrant /home/vagrant/ecommerces
fi
PROJECT_DIR=/home/vagrant/ecommerces
...
sudo su - vagrant /bin/bash -c "source /usr/local/bin/virtualenvwrapper.sh;cd ${PROJECT_DIR};mkvirtualenv --python=`which python3.3` ecommerces; deactivate;"
